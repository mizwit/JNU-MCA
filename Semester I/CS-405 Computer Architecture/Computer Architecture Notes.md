...
### References
- [Computer System Architecture by M. Morris Mano](Materials/Computer%20System%20Architecture%20(M.%20Morris%20Mano).pdf)
- [Computer Architecture and Organization by IIT Kharagpur](Materials/Computer%20Architecture%20and%20Organization%20IITK.pdf)
...
![8085 Training Kit - 1](Images/30.jpg)
![8085 Training Kit - 2](Images/31.jpg)
...
![Pipeline Speedup Graph](Images/32.png)

### Clock Skew, Jitter and Setup Time
![Clock Skew, Jitter and Setup Time](Images/33.png)

---

### Scheduling of Non-linear Pipelines
![Scheduling of Non-linear Pipelines](Images/34.png)
![Latency Analysis 1](Images/35.png)
![Latency Analysis 2](Images/36.png)

### Collision Free Scheduling
![Collision Free Scheduling 1](Images/37.png)
![Collision Free Scheduling 2](Images/38.png)
![Collision Free Scheduling 3](Images/39.png)

### The Scheduling Algorithm
![The Scheduling Algorithm](Images/40.png)

### Optimizing a Pipeline Schedule
![Optimizing a Pipeline Schedule 1](Images/41.png)
![Optimizing a Pipeline Schedule 2](Images/42.png)

---

### Pipeline - Exercises
![Pipeline - Exercise 1](Images/43.png)
![Pipeline - Exercise 2](Images/44.png)

---

### Fixed Point Addition Pipeline
![Fixed Point Addition Pipeline](Images/45.png)
![A 4-bit Ripple Carry Adder 1](Images/46.png)
![A 4-bit Ripple Carry Adder 2](Images/47.png)
![A 4-bit Ripple Carry Adder 3](Images/48.png)